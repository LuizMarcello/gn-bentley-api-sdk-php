...
<body>
  ...
  <main>
    ...
    <div class="btn-outline-primary" style="font-family:Arial, Helvetica, sans-serif; font-size: large; font-weight: bold; margin-left: 20%; margin-top: 10%;">
      <p> Projeto Jeruena - Internet Ilimitada </p>
      <p> Internet via rádio com a velocidade de fibra ótica</p>
      <br><br>
      <p style="font-size: 25px;">Adesão de equipamentos - Valor R$ 1.900,00</p>
    </div>
    ...
    <footer class="main-footer">
      <div class="float-center d-none d-sm-block" style="bottom: 0; position:absolute; margin-left:25%; margin-bottom: 1%">
