        ...
        <div class="flex-box container-box">
            ...
            <form method="POST" id="form">
                <div class="content-box">
                    ...
                    <!-- <input type="text" name="telefone" size="20" maxlength="15" placeholder="Telefone"
                         maxlength="14" onkeypress="mascara(this)" required> -->
                    <input type="text" name="telefone" id="telefone" placeholder="Telefone" required>

                    <input type="email" name="email" placeholder="Email" maxlength="45" required>

                    <input type="password" name="senha_usuario" id="senha_usuario" autocomplete="new-password" placeholder="Senha" maxlength="45">
                    ...
                    <button onclick="mostrarASenhaRepete()" type="button" id="mostrarrSenhaRepete" class="btn btn-primary botao btn-sm">
                        Mostrar Senha</button>
